...
if selected == 'Equipo':
   ...
   image1 = Image.open('WhatsApp Image 2022-12-10 at 2.34.25 PM.jpeg')
   col1.header("Miguel Calistro Aguilar")
   col1.image(image1, use_column_width=True)
   image2 = Image.open('WhatsApp Image 2022-12-10 at 2.30.30 PM.jpeg')
   col2.header("Brigytt Contreras Melgar")
   col2.image(image2, use_column_width=True)
   image3 = Image.open('6e2c9b66-462a-48a0-8fd7-bbd8974bf56e.jpg')
